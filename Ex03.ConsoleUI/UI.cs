...
namespace GarageManagementSystem.ConsoleUI
{
    internal class UI
    {
        ...
        private readonly GarageLogic.VehicleFactory r_Factory = new GarageLogic.VehicleFactory();
        ...
        public void RunMenu()
        {
            ...
            {
            Console.WriteLine("Garage Management System Menu");
            Console.WriteLine("=============================");
        ...
        private void addVehicleUI()
        {
            ...
            if (r_Garage.CheckIfInGarage(licenseNumberInput))
            {
            ...
            else
            {
                ...
                vehicle = r_Factory.CreateVehicle((GarageLogic.eVehicle)int.Parse(Console.ReadLine()));
                ...
                r_Garage.AddToGarage(new GarageLogic.VehicleOwner(ownerName, ownerPhoneNumber), vehicle);
        ...
        private void getLicenseNumbersUI()
        {
            ...
            if(answer[0] == '0')
            {
                List<string> licenseNumbers = r_Garage.GetLicenseNumbers();
            ...
            else
            {
                ...
                List<string> licenseNumbers = r_Garage.SortVehiclesBySate((GarageLogic.eVehicleState)int.Parse(Console.ReadLine()));
                if(licenseNumbers.Count == 0)
                {
        ...
        private void changeVehicleStateUI()
        {
            ...
            if(r_Garage.CheckIfInGarage(inputLicenseNumber, false))
            {
                r_Garage.ChangeVehicleState(inputLicenseNumber, (GarageLogic.eVehicleState)newVehicleState);
        ...
        private void inflateTiresToMaxUI()
        {
            ...
            if (r_Garage.CheckIfInGarage(inputLicenseNumber, false))
            {
                r_Garage.InflateTiresToMax(inputLicenseNumber);
        ...
        private void refuelVehicleUI()
        {
            ...
            if (r_Garage.CheckIfInGarage(inputLicenseNumber, false))
            {
                r_Garage.RefuelVehicle(inputLicenseNumber, (GarageLogic.eFuelType)inputFuelType, inputAmountOfLitersToAdd);
        ...
        private void chargeVehicleUI()
        {
            ...
            if (r_Garage.CheckIfInGarage(inputLicenseNumber, false))
            {
                r_Garage.ChargeVehicle(inputLicenseNumber, inputAmountOfMinutesToCharge);
        ...
        private void printVehicleInfo()
        {
            ...
            if (r_Garage.CheckIfInGarage(inputLicenseNumber, false))
            {
                vehicleInfo = r_Garage.GetVehicleDetailsByLicenseNumber(inputLicenseNumber);
